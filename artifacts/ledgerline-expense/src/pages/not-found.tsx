  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-center bg-[var(--color-paper)] p-6">
      <div className="w-full max-w-md border-t-2 border-[var(--color-line-strong)] pt-6 text-center">
        ...
        <Link className="mt-5 inline-flex min-h-11 items-center justify-center bg-[var(--color-ink)] px-4 text-xs font-semibold uppercase tracking-[0.08em] text-[var(--color-paper)] hover:bg-[var(--color-accent)]" href="/" data-testid="link-not-found-home">
          Return to overview
        </Link>
      </div>
    </div>
